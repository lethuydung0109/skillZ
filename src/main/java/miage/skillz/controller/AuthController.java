...
import miage.skillz.payload.reponse.JwtResponse;
import miage.skillz.payload.reponse.MessageResponse;
import miage.skillz.payload.request.LoginRequest;
...
import miage.skillz.security.jwt.JwtUtils;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "concepteur":
                        Role modRole = roleRepository.findByName(ERole.ROLE_CONCEPTEUR)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(modRole);
